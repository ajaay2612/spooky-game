import{S as e}from"./index-B1yC5BtO.js";import"./logDepthDeclaration-iVTgUdOi.js";import"./helperFunctions-V_Hi2Hl6.js";const o="decalFragmentDeclaration",X=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=X);const t="defaultFragmentDeclaration",F=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=F);const r="prePassDeclaration",N=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=N);const a="oitDeclaration",R=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=R);const n="lightFragmentDeclaration",M=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=M);const l="lightUboDeclaration",O=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=y);const s="lightsFragmentFunctions",b=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=b);const d="shadowsFragmentFunctions",_=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=_);const c="samplerFragmentDeclaration",U=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=U);const h="fresnelFunction",W=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=W);const v="reflectionFunction",z=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=z);const u="imageProcessingDeclaration",H=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=H);const p="imageProcessingFunctions",G=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=G);const m="bumpFragmentMainFunctions",V=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=V);const S="bumpFragmentFunctions",B=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=B);const g="clipPlaneFragmentDeclaration",k=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=k);const E="fogFragmentDeclaration",Y=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Y);const C="clipPlaneFragment",$=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=$);const D="bumpFragment",q=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=q);const L="decalFragment",Z=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Z);const I="depthPrePass",Q=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Q);const w="lightFragment",j=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=j);const A="logDepthFragment",J=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=J);const T="fogFragment",K=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=K);const P="oitFragment",ee=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ee);const i="defaultPixelShader",x=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=x);const re={name:i,shader:x};export{re as defaultPixelShader};
